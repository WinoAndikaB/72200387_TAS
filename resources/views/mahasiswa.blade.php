        ...
        <div class="row">
            ...
            <div class="col-lg-10 vh-100">
                <div class="card mt-4">
                    ...
                    <a name="" id="" class="btn btn-primary" href="/mahasiswa/formulirmhs" role="button"><i class="bi bi-plus-square-fill"></i> Tambah Mahasiswa </a>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <td>
                                <a href="/mahasiswa/editmhs/{{ $m -> id }}" class="btn btn-outline-primary"><i class="bi bi-pencil-square"></i> Edit</a>
                                <a href="/mahasiswa/deletemhs/{{ $m -> id }}" class="btn btn-outline-danger"><i class="bi bi-x-square"></i> Hapus </a>
                            </td>
                            </tr>
                            @endforeach
                        </tbody>
                        </table>
                        <b>Total Keseluruhan :</b> {{$mahasiswa->total()}}
                        <b>Total Data Halaman :</b> {{$mahasiswa->count()}}
                        <b>Halaman :</b> {{$mahasiswa->currentPage()}}
